...
\newcommand{\odnote}[1]{\textcolor{purple}{[OD:#1]}}
%===============================
...
\title{Differences Between Experimental Practices in Software Engineering and Other Disciplines? Two Ethnographical Studies}
